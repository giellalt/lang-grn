...
This directory contains source files for the Guarani language morphology
...
-   <https://giellalt.uit.no/lang/grn/index.html> (analyser)
...
The Guarani language sources can be acquired using [giella SVN
