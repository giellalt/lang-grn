...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_grn to login script."
...
# the current dir:
if   test x${GTLANG_grn} = x ; then
	echo "WARNING: The variable \${GTLANG_grn} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_grn} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_grn} has the value:"
	echo "  ${GTLANG_grn}"
